...
//        . ' <span class="ub_countdown_second">' . $seconds . '</span> ' . __('seconds', 'ultimate-blocks');
    ...
    $defaultFormat = '<div class="timer-container"><div class="ub_countdown_week">' . $weeks . '</div>' . '<div>' . __('СЕДМИЦИ', 'ultimate-blocks') . '</div></div>'
        . '<div class="timer-container"><div class="ub_countdown_day">' . $days . '</div>' . '<div>' . __('ДНИ', 'ultimate-blocks') . '</div></div>'
