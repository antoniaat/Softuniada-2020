...
function ub_render_countdown_block($attributes){
    ...
    $defaultFormat = '<div class="timer-container"><div class="ub_countdown_day">' . $days . '</div>' . '<div>'. __('ДНИ', 'ultimate-blocks').'</div></div>'
    . '<div class="timer-container"><div class="ub_countdown_hour">' . $hours . '</div>' . '<div>'. __('ЧАСОВЕ', 'ultimate-blocks').'</div></div>'
    .'<div class="timer-container"><div class="ub_countdown_minute">' . $minutes . '</div>' . '<div>'. __('МИНУТИ', 'ultimate-blocks').'</div></div>'
    .'<div class="timer-container"><div class="ub_countdown_second">' . $seconds . '</div>' . '<div>'. __('СЕКУНДИ', 'ultimate-blocks').'</div></div>';
//    $defaultFormat = '<span class="ub_countdown_day">' . $days . '</span> ' . __('ДНИ', 'ultimate-blocks')
  //      . ' <span class="ub_countdown_hour">' . $hours . '</span> ' . __( 'ЧАСОВЕ', 'ultimate-blocks' )
    //    . ' <span class="ub_countdown_minute">' . $minutes . '</span> ' . __( 'МИНУТИ', 'ultimate-blocks' )
      //  . ' <span class="ub_countdown_second">' . $seconds . '</span> ' . __( 'СЕКУНДИ', 'ultimate-blocks' );
    ...
    $odometerFormat = '<div class="ub-countdown-odometer-container">
                        <span>'.__( 'Days', 'ultimate-blocks' ).'</span>'.$emptySpan.
