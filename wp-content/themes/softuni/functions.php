<?php
/**
 * SoftUni functions and definitions
 *
...
if (!function_exists('softuni_setup')) :
    /**
     ...
     */
    function softuni_setup()
    {
        /*
         * Make theme available for translation.
         * Translations can be filed in the /languages/ directory.
         * If you're building a theme based on SoftUni, use a find and replace
         * to change 'softuni' to the name of your theme in all the template files.
         */
        load_theme_textdomain('softuni', get_template_directory() . '/languages');
        ...
        add_theme_support('custom-background', apply_filters('softuni_custom_background_args', array(
...
add_action('after_setup_theme', 'softuni_setup');
 ...
 */
function softuni_content_width()
{
    // This variable is intended to be overruled from themes.
    // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
    // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
    $GLOBALS['content_width'] = apply_filters('softuni_content_width', 640);
}

add_action('after_setup_theme', 'softuni_content_width', 0);
 ...
 */
function softuni_widgets_init()
{
    register_sidebar(array(
        'name' => esc_html__('Sidebar', 'softuni'),
        'id' => 'sidebar-1',
        'description' => esc_html__('Add widgets here.', 'softuni'),
...
add_action('widgets_init', 'softuni_widgets_init');
...
function softuni_scripts()
{
    ...
    wp_enqueue_script('softuni-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true);
...
add_action('wp_enqueue_scripts', 'softuni_scripts');
